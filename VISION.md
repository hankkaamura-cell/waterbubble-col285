...
### 🧠 Project METIS – Squadron Awareness Layer

*Tsumikaze here.*

Project METIS is a concept of my own inception, built around three simple operational questions:

- **Where are we?**
- **What are we doing?**
- **Can the rest of the squadron see that in near real time?**

Phase 1 of METIS answers the first question through the location layer: identifying where participating CMDRs are operating within the Water Bubble.

Phase 2 will answer the second question, or come as close as possible to answering it, by identifying what squadron members are currently doing: trade, exploration, construction support, BGS activity, mission-running, logistics, or other operational roles.

Phase 3 will answer the third question by allowing squadron members to see one another’s current activity through over-the-air updates, or as close to real time as the system can reasonably support, with an intended update window of roughly ten seconds.

The project takes its name from **Metis**, the Greek Titaness associated with wisdom, counsel, and practical intelligence. That namesake fits the goal of the system: METIS is not meant to be just a map layer, but a squadron awareness layer. Its purpose is to turn location, activity, and shared operational context into useful information for everyone participating in the Water Bubble.

In short, METIS is intended to evolve the project from an interactive star map into a living coordination system for squadron activity in The Water Bubble.
...
- METIS location layer: show participating CMDR locations when available
- METIS activity layer: infer or report what each CMDR is currently doing
- Near-real-time squadron visibility through OTA-style updates
- Optional squadron activity feed: who is where, doing what, and in support of which objective
